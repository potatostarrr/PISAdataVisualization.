function drawLine(csv) {
    ...
    data
        ...
        .forEach(function(d) {
            ...
            data.forEach(function(dd) {
                if (dd.endY >= d.startY) dd.endY +=
                    additionalSpacing;
                if (dd.country != d.country && dd.startY >= d.startY)
                    dd.startY += additionalSpacing;
            });
            previousY = thisY;
        });
        ...
        .style("stroke", function(d, i) {
		 // change line color depends on whether male have higher scoer
            if (d.male > d.female) {
                ...
                increasedCountry.add(d.country);
                return "red";
            }
        });
